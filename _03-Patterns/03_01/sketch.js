...
function draw() {
 // background(255);
  smooth();
  //for(i = width/2; i <= width; i+= width){
    rectangle(width/2,height/2,width/7,rotator);
    rectangle(width/10,height/2.5,width/14,rotator);
    rectangle(width-width/10,height/2.5,width/14,rotator);
  //}
  rotator++;
  //noLoop();
}
